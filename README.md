...
## 2.2 — Доп. настройки для удобства
По нажатию кнопки **"Программа"** можно включить настройки "Запускаться вместе с системой" и "Запомнить последний профиль", эти настройки позволят при включении компьютера сразу подключаться к последнему конфигу(Придётся только нажать включение от имени администратора)
